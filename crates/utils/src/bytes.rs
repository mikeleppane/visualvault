...
mod tests {
    ...
    fn test_format_bytes_terabytes() {
        ...
        assert_eq!(format_bytes(1024u64.pow(4) * 10), "10.00 TB");
        assert_eq!(format_bytes(1024u64.pow(4) * 100), "100.00 TB");
    }

    #[test]
    fn test_format_bytes_large_terabytes() {
        // Test values larger than 1024 TB (should still show as TB)
        assert_eq!(format_bytes(1024u64.pow(4) * 2048), "2048.00 TB");
        assert_eq!(format_bytes(1024u64.pow(4) * 10000), "10000.00 TB");
    }
    ...
    fn test_format_bytes_common_file_sizes() {
        ...
        assert_eq!(format_bytes(1024u64.pow(3) * 25), "25.00 GB"); // Blu-ray
    }
